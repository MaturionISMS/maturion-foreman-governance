...
export function generatePRDescription(context: PRContext): string {
  ...
  sections.push('- ✅ Changes aligned with system architecture')
  sections.push('- ✅ No breaking changes introduced')
  sections.push('- ✅ Limited scope to defined module boundaries')
  sections.push('')
  sections.push('### QA Governance')
  sections.push('- ✅ All builder outputs validated by QA engine')
  sections.push('- ✅ QA-of-QA meta-review performed')
  sections.push('- ✅ Quality gates enforced before PR assembly')
  sections.push('')
  sections.push('### Security & Compliance')
  sections.push('- ✅ Organisation ID validated for all tasks')
  sections.push('- ✅ No secrets detected in generated code')
  sections.push('- ✅ Audit trail complete and logged')
  sections.push('')
  ...
  sections.push('---')
  sections.push('')
  sections.push('🤖 *Generated by Maturion Foreman under QA governance. No human code review required.*')
